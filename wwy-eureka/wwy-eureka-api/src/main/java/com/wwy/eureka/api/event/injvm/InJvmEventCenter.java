...
public class InJvmEventCenter implements EventCenter {
	...
	private final ExecutorService executor = new ScheduledThreadPoolExecutor(Constants.AVAILABLE_PROCESSOR * 2, new NamedThreadFactory("LTS-InjvmEventCenter-Executor",true));
